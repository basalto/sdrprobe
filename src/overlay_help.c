...
},
{
    ...
    "whose harmonics leak into the tuner -- or it sits where the receiver's own "
    "DC offset lands and the DC-spike filter is off. Sweeping 470-690 MHz with "
    "the antenna unplugged leaves a dozen of them standing 20 dB above the "
    "floor, inside the television allocation, looking exactly like signals. "
    "They are marked and never removed: a real transmitter can sit on a "
    "harmonic, and the surest test is still to unplug the antenna and sweep "
    "again, because an artifact stays.\n"
    "\n"
