...
},
{
    ...
    "\n"
    "Soft Symbol Magnitudes (|Im|). One bar per demodulated bit: how far that "
    "bit landed from the decision boundary. Tall bars are confident bits. A "
    "run of short bars marks where the burst faded or was interfered with -- "
    "that is the stretch the Viterbi decoder had to bridge, and where a parity "
    "failure comes from when one comes.\n"
    "\n"
