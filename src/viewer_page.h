...
"    if (state.type === 'link_health') { lastHealth = state; renderHealth(); return; }\n"
...
"      + '<div class=\"row\">send-queue high-water <span>' + kb(h.send_queue_high_water) + ' KB</span></div>'\n"
"      + '<div class=\"row\">received <span>' + kb(throughputBps) + ' KB/s</span> (this tab)</div>'\n"
