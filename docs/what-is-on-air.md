...
`site-a`, a telescopic whip indoors, 29.7 dB of gain, an R820T behind
...
| Aeronautical radionavigation | 5 | -45.5 | 17.9 | 75.0005 MHz is **25 MHz x 3**. Every ILS marker sideband -- 400, 1300, 3000 Hz, both sides -- sits within 3 dB of a control probe at an empty frequency, where a 30%-depth AM sideband would stand 42 dB up. `testfiles/carrier_75000_bare.bin` |
