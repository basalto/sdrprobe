...
static struct survey_record_setup the_setup(void) {
    ...
    snprintf(setup.receiver, sizeof(setup.receiver), "receiver-a");
...
static void test_a_survey_without_an_application(void) {
    ...
    check_str("which receiver", record.setup.receiver, "receiver-a");
...
static void test_the_setup_comes_from_the_installation(void) {
    ...
    check_str("and the site", setup.site, "site-a");
    ...
    check_str("and one that can, does", setup.receiver, "receiver-a");
