...
static void test_who_the_receiver_is(void) {
    ...
    installation_identify(&inst, "receiver-a", NULL);
...
static void test_a_legacy_correction_is_not_applied_until_claimed(void) {
    ...
    installation_set_id(inst.profile[0].site, "site-a");
    inst.profile[0].receiver[0] = '\0';
    inst.profile[0].ppm = -31;

    installation_set_id(inst.site, "site-a");
    installation_identify(&inst, "receiver-a", NULL);
...
static void test_the_history_path(void) {
    ...
    const char *legacy = "surveys/history-site-a.txt";
    ...
    check_true("and it names all three",
               strstr(setup, "receiver-a") != NULL &&
               strstr(setup, "site-a") != NULL &&
...
static void test_a_legacy_baseline_is_inert(void) {
    ...
    const char *legacy_path = "surveys/history-site-a.txt";
    ...
    site_history_init(&legacy, "site-a");
